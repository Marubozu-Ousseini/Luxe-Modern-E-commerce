...
export const CartIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden={props['aria-hidden'] ?? true} focusable="false" {...props}>
...
export const StarIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" aria-hidden={props['aria-hidden'] ?? true} focusable="false" {...props}>
...
// Outline variants for a lighter, stroke-based appearance (mobile-friendly)
export const UserIconOutline: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden={props['aria-hidden'] ?? true} focusable="false" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.5 20.25a8.25 8.25 0 1 1 15 0v.75h-15v-.75Z" />
  </svg>
);

export const OrdersIconOutline: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden={props['aria-hidden'] ?? true} focusable="false" {...props}>
...
export const HeartIconOutline: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" aria-hidden={props['aria-hidden'] ?? true} focusable="false" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M21 8.25c0-2.485-2.014-4.5-4.5-4.5-1.52 0-2.862.747-3.75 1.89-.888-1.143-2.23-1.89-3.75-1.89-2.486 0-4.5 2.015-4.5 4.5 0 6.75 8.25 10.5 8.25 10.5S21 15 21 8.25Z" />
  </svg>
);
