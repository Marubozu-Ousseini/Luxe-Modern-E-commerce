...
const HeroSection: React.FC<HeroSectionProps> = ({ pageKey, title, description, children }) => {
  return (
    <PageBackground pageKey={pageKey} overlayClassName="bg-royal/35">
      <section className="relative mb-10 overflow-hidden">
        <div className="relative h-[52vh] min-h-[360px] w-full flex flex-col items-center justify-center text-center px-6">
